...
class DataViewController: UIViewController, UIScrollViewDelegate {
    ...
    var testView: PDFRenderView!
    var currentIndex: Int = 0
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        testView = PDFRenderView(frame: CGRect(x: 0, y: 0, width: 651.96799999999996, height: 841.88999999999999))
//        testView = PDFRenderView(frame: self.view.bounds)
